export default {
  ...
  admin: {
    ...
    ops: {
      ...
      operations: {
        title: '运营控制台',
        description: '看请求、看异常、看上游、看额度，一屏处理日常运维。',
        businessLimited: '业务限流',
        slaIn: 'SLA 内',
        supplierAccounts: '供应商账号',
        upstreamGroups: '上游分组',
        abnormalRequests: '异常请求',
        abnormalDescription: '最近的失败请求和上游错误，直接跳转到详细排查页。',
        lastUpdated: '最近更新时间',
        notUpdated: '未更新',
        noRecentAbnormalRequests: '暂无最近异常请求。',
        supplierHealth: '供应商状态',
        supplierDescription: '这里看的是你接进来的上游中转和直连供应商。',
        manageAccounts: '管理账号',
        noSupplierAccounts: '暂无供应商账号。',
        limitsAndRate: '限额与限速',
        limitsDescription: '额度、RPM、并发和分组倍率都在这里串起来。',
        manageGroups: '管理分组',
        noCapacityData: '暂无分组容量数据。',
        upstreamAccounts: '上游账号',
        partialLoadFailed: '部分辅助数据加载失败：'
      },
      // Dashboard
      systemHealth: '系统健康',
      overview: '概览',
