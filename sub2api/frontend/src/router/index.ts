...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    name: 'AdminOperationsConsole',
    component: () => import('@/views/admin/OperationsConsoleView.vue'),
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
      title: 'Operations Console',
      titleKey: 'admin.ops.operations.title',
      descriptionKey: 'admin.ops.operations.description'
    }
  },
  {
    path: '/admin/ops',
