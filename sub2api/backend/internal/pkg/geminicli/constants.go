...
const (
	...
	// GeminiCLIOAuthClientID/Secret are provided via environment variables for deployments
	// that use a built-in Gemini CLI OAuth client.
	GeminiCLIOAuthClientID     = "gemini-cli-oauth-client-id"
